...
public class EventReceiver {
    ...
    public Event receive(String tenantId, String userId, String productId, EventType eventType, Map<String, Object> payload, double amount, String device, String campaignId) throws InterruptedException {
        ...
        Event event = new Event(EventIdGenerator.generateId(), tenantId, userId, productId, eventType, System.currentTimeMillis(),partition, payload, amount, device, campaignId);
